...
today = date.today() # "No player available"
day_englihs = datetime.today().strftime('%A')

if day_englihs == "Monday":
    dia = "Lunes"
elif day_englihs == "Tuesday":
    dia = "Martes"
elif day_englihs == "Wednesday":
    dia = "Miércoles"
elif day_englihs == "Thursday":
    dia = "Jueves"
elif day_englihs == "Friday":
    dia = "Viernes"
elif day_englihs == "Saturday":
    dia = "Sábado"
else:
    dia = "Domingo"
...
# FECHA CUMPLEAÑOS
        if today.day == 30 and today.month == 6:
            tmp_message = "Feliz cumpleaños"
        else:
            tmp_message = "       {} {} / {}".format(dia, today.day, today.month)
